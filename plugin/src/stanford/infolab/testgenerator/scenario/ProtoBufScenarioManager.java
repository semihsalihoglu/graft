...
import stanford.infolab.debugger.testgenerator.scenario.ScenarioProto.GiraphScenario;
import stanford.infolab.debugger.testgenerator.scenario.ScenarioProto.GiraphScenario.Scenario.InMsg;
import stanford.infolab.debugger.testgenerator.scenario.ScenarioProto.GiraphScenario.Scenario
    .Neighbor;
import stanford.infolab.debugger.testgenerator.scenario.ScenarioProto.GiraphScenario.Scenario;
import stanford.infolab.debugger.testgenerator.scenario.ScenarioProto.GiraphScenario.Scenario
    .Neighbor.OutMsg;
...
public class ProtoBufScenarioManager<I extends WritableComparable, V extends Writable, 
    E extends Writable, M1 extends Writable, M2 extends Writable>
    implements IScenarioManager<I, V, E, M1, M2> {
  ...
  public ScenarioList<IScenario<I, V, E, M1, M2>> load(String fileName)
    ...
    ScenarioList<IScenario<I, V, E, M1, M2>> scenarioList =
        new ScenarioList<>(classUnderTest, vertexIdClass, vertexValueClass, edgeValueClass,
            incomingMessageClass, outgoingMessageClass);

    for (ScenarioOrBuilder protoBufScenario : giraphScenario.getScenarioOrBuilderList()) {
      DefaultScenario<I, V, E, M1, M2> scenario = new DefaultScenario<>();
  ...
  public void save(String fileName, ScenarioList<IScenario<I, V, E, M1, M2>> scenarioList)
    ...
    for (IScenario<I, V, E, M1, M2> scenario : scenarioList.getScenarios()) {
