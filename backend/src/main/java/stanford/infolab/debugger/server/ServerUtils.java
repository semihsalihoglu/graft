...
public class ServerUtils {
    ...
    /*
     * Reads the protocol buffer trace corresponding to the given jobId, superstepNo and vertexId
     * and returns the giraphScenarioWrapper. 
     * @param jobId : ID of the job debugged.
     * @param superstepNo: Superstep number debugged.
     * @param vertexId - ID of the vertex debugged. 
     * Returns GiraphScenarioWrapper. 
     */
    public static GiraphScenarioWrapper readScenarioFromTrace(String jobId, 
    		long superstepNo, String vertexId) throws IOException, ClassNotFoundException  {
        ...
        GiraphScenarioWrapper giraphScenarioWrapper = 
        		giraphSaverLoader.loadFromHDFS(fs, traceFilePath);
    ...
    /*
     * Returns a list of vertice Ids that were debugged in the given superstep
     * by reading (the file names of) the debug traces on HDFS. File names
     * follow the tr_stp_<superstepNo>_vid_<vertexId>.tr naming convention.
     */
