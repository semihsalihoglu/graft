 ...
 * The other class Graft generates is {@link BuggySimpleShortestPathsDebugComputationModified}.
 * Please see the Graft documentation for more details on how Graft instruments {@link Computation}
 * classes.
 */
@SuppressWarnings({ "rawtypes", "unchecked" })
public class BuggySimpleShortestPathsDebugComputationToRun extends
		BuggySimpleShortestPathsDebugComputationModified {
